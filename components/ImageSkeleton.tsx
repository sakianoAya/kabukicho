...
export function ImageSkeleton({ className, aspectRatio = "video" }: ImageSkeletonProps) {
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-lg bg-black/50 backdrop-blur-sm",
        aspectClasses[aspectRatio],
        className,
      )}
    >
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-purple-900/20 via-pink-900/20 to-blue-900/20 animate-pulse"></div>

      {/* Neon Border */}
      <div className="absolute inset-0 border border-purple-500/20 rounded-lg neon-glow"></div>
